...
Player_tft::Player_tft(Point_extended starting_point, TFT_eSPI *tft, Matrix_map *matrix_map)
{
...
Point_extended Player_tft::move_forward()
{
...
Point_extended Player_tft::move_backwards()
{
    float x,y;
...
Point_extended Player_tft::get_current_player_position()
{
...
void Player_tft::set_player_posistion(Point_extended point)
{
